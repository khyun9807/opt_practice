package com.optpractice.post.entity;

import com.optpractice.global.entity.BaseTimeEntity;
...
@Table(
        ...
        indexes = {
                ...
                @Index(name = "idx_posts_deleted_merchant_type", columnList = "is_deleted, merchant, type")
        }
)
