package com.optpractice.auth;

import com.optpractice.auth.jwt.entity.JwtType;
import com.optpractice.auth.jwt.entity.RefreshTokenEntity;
import com.optpractice.auth.jwt.util.JwtParseUtil;
import com.optpractice.auth.jwt.util.JwtRefreshTokenUtil;
import com.optpractice.auth.jwt.util.JwtTokenUtil;
import com.optpractice.auth.util.KakaoOAuthUtilImpl;
import com.optpractice.auth.util.OAuthUserInfo;
import com.optpractice.global.exception.ApiException;
import com.optpractice.global.response.ErrorCode;
import com.optpractice.user.UserService;
import com.optpractice.user.entity.AuthType;
import com.optpractice.user.entity.User;
import com.optpractice.user.entity.UserRole;
